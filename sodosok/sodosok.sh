...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/Bringas-tunnel/permission/main/ipmini | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# Link Hosting Kalian
tarapkuhing="raw.githubusercontent.com/Bringas-tunnel/v6/main/sododok"
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/Bringas-tunnel/v6/main/sododok/addss.sh"
wget -O delss "https://raw.githubusercontent.com/Bringas-tunnel/v6/main/sododok/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/Bringas-tunnel/v6/main/sododok/cekss.sh"
wget -O renewss "https://raw.githubusercontent.com/Bringas-tunnel/v6/main/sododok/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
